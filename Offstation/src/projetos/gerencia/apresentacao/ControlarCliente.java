...
public final class ControlarCliente {
    ...
    public ICliente salvar(ICliente cliente) {
        try {
            ...
            Principal.getInstancia().log(new StringBuilder().append("Cliente '").append(cliente.getNomeCompleto()).append("' salvo com sucesso! Novo ID: ").append(cliente.getId()).toString());
